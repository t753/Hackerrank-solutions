// Reverse Shuffle Merge.cpp : Defines the entry point for the console application.
//
...
template<class T>
class XX {
	typename vector<string::size_type>::size_type a;   // T::A is a type
};
...
string smallest_A(string &str) {
	...
	static vector<string::size_type>::size_type  next_to_use[26];
